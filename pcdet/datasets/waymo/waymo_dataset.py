...
def create_waymo_infos(dataset_cfg, class_names, data_path, save_path,
                       ...
                       workers=min(16, multiprocessing.cpu_count()), sampled_interval=1):
...
if __name__ == '__main__':
    ...
    if args.func == 'create_waymo_infos':
        ...
        create_waymo_infos(
            ...
            data_path=Path(dataset_cfg.get('DATA_PATH')), #ROOT_DIR / 'data' / 'waymo',
            save_path=Path(dataset_cfg.get('DATA_PATH')), #ROOT_DIR / 'data' / 'waymo',
