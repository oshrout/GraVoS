...
class RoIHeadTemplate(nn.Module):
    ...
    def get_box_reg_layer_loss(self, forward_ret_dict):
        ...
        if loss_cfgs.REG_LOSS == 'smooth-l1':
            ...
            tb_dict['rcnn_loss_reg'] = rcnn_loss_reg #rcnn_loss_reg.item()
            ...
            if loss_cfgs.CORNER_LOSS_REGULARIZATION and fg_sum > 0:
                ...
                tb_dict['rcnn_loss_corner'] = loss_corner #loss_corner.item()
        else:
            raise NotImplementedError
    ...
    def get_box_cls_layer_loss(self, forward_ret_dict):
        ...
        tb_dict = {'rcnn_loss_cls': rcnn_loss_cls} #{'rcnn_loss_cls': rcnn_loss_cls.item()}
    ...
    def get_loss(self, tb_dict=None):
        ...
        tb_dict['rcnn_loss'] = rcnn_loss #rcnn_loss.item()
